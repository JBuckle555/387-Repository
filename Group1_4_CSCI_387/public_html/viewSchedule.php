...
<button class="buttonP" onclick="logout()" ><p>Logout<p></button>
  ...
  <a href="" class="active"> &nbsp &nbsp &nbsp &nbsp   My Schedule &nbsp &nbsp &nbsp &nbsp
</a>
...
<!--
  ...
  -->  <div class="targetP" ><br>
  	...
  	<h1 id = "title" style="text-align: left ; margin-top:0px;">My Schedule</h1><!--
	--><hr>
